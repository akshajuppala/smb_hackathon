      ...
      <div className="overflow-hidden rounded-[28px] border border-gray-200 bg-white shadow-sm">
        <div className="bg-gradient-to-br from-amber-50 via-white to-teal-50 px-5 pt-6 pb-4 sm:px-6">
          ...
          <p className="mt-5 max-w-md text-sm text-gray-600">
            {t('Finish the business info, interior, and exterior assessments so the insurer has a full underwriting package. We will guide you step by step.')}
          </p>
        </div>
        ...
        <div className="space-y-3 px-5 pt-3 pb-5 sm:px-6 sm:pt-4 sm:pb-6">
          {ASSESSMENTS.map((assessment) => {
            ...
            return (
              ...
              >
                <div>
                  <p className="text-base font-semibold text-gray-900">{t(assessment.title)}</p>
                  <p className="mt-1 text-sm text-gray-600">{t(assessment.description)}</p>
                </div>
        ...
        <div className="absolute inset-0 z-50 flex items-center justify-center bg-gray-900/40 px-4">
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.16em] text-gray-500">{t('Why this matters')}</p>
            ...
            <p className="mt-4 text-sm leading-6 text-gray-600">{t(activeAssessment.whyThis)}</p>
